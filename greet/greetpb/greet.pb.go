...
type Greeting struct {
	...
	FirstName string `protobuf:"bytes,1,opt,name=first_name,json=firstName,proto3" json:"first_name,omitempty"` // assign tag number 1, mean first field for greeting message
